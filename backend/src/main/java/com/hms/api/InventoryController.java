...
public class InventoryController {
    ...
    public InventoryDtos.WarehouseItem updateWarehouse(
            ...
            @RequestHeader(value = "X-Hotel-ID", required = false) String hotelHeader,
            @Valid @RequestBody InventoryDtos.WarehouseUpdateRequest body) {
        return invExtService.updateWarehouse(hotelId, hotelHeader, warehouseId, body);
    }
    ...
    public void deleteWarehouse(
            ...
            @PathVariable UUID warehouseId,
            @RequestHeader(value = "X-Hotel-ID", required = false) String hotelHeader) {
        invExtService.deleteWarehouse(hotelId, hotelHeader, warehouseId);
    }
