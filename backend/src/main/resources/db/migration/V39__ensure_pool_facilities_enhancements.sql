-- Re-applies the same idempotent DDL as V32 for databases where version 32 was recorded
-- against a different script (checksum repair) so pool facility tables were never created.
