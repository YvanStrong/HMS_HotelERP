-- ============================================================
-- V33: Inventory Management Extensions
-- Customers, Sales Invoices, Warehouses, Stock Transfers
-- ============================================================
...
-- Add outstanding balance to suppliers (if not present)
