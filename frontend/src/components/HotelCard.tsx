    ...
    <article className="group bg-white rounded-2xl border border-border/60 shadow-soft hover:shadow-float hover:border-primary/30 transition-all duration-300 overflow-hidden">
      ...
      <div className="relative h-48 overflow-hidden bg-muted">
        {imageUrl ? (
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center" style={{ background: "linear-gradient(135deg, hsl(140 35% 96%) 0%, hsl(142 30% 88%) 100%)" }}>
            <div className="w-16 h-16 rounded-2xl bg-white/80 shadow-sm flex items-center justify-center mb-3">
