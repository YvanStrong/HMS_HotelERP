...
const NAV: { href: string; label: string; icon?: string }[] = [
  ...
  { href: "/platform/modules", label: "Modules & Pricing", icon: "M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 14a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 14a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4" },
  { href: "/platform/categories", label: "Categories", icon: "M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" },
